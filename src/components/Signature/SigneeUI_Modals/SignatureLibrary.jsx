      ...
      <div className="flex-1 overflow-y-auto p-4">
        {savedSignatures.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-xs text-gray-400">Create and save signatures to build your personal library</p>
          </div>
        ) : (
          <div className="space-y-3">
            {savedSignatures.map((signature) => {
              ...
              return (
                <div
                  key={signature.id}
                  className={`relative group border rounded-xl p-4 cursor-pointer transition-all duration-200 ${
                    isSelected
                ...
                >
                  {/* Signature Preview */}
                  <div className="h-16 mb-3 bg-gray-50 rounded-lg border flex items-center justify-center overflow-hidden">
                    <img
                      src={signature.data}
                      alt="Saved signature"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <span className={`inline-flex items-center px-2 py-1 rounded-md text-xs font-medium ${getTypeBadgeColor(signature.type)}`}>
