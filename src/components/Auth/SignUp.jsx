                        ...
                        <form onSubmit={handleSignUp} className="space-y-3 sm:space-y-4 lg:space-y-6">
                            <div className="relative group">
                                <div className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 z-10">
                                    <FontAwesomeIcon icon={faUser} className="text-slate-400 group-focus-within:text-CloudbyzBlue transition-colors duration-200 text-sm sm:text-base" />
                                </div>
                                <input
                                    type="text"
                                    id="username"
                            ...
                            <div className="flex items-start space-x-2 sm:space-x-3">
                                <input
                                    ...
                                    className="mt-0.5 sm:mt-1 w-3 h-3 sm:w-4 sm:h-4 text-CloudbyzBlue bg-gray-100 border-gray-300 rounded focus:ring-CloudbyzBlue focus:ring-2"
                                />
                            ...
                            <button
                                type="submit"
                                className={`w-full py-2.5 sm:py-3 lg:py-4 font-semibold rounded-lg sm:rounded-xl shadow-lg transition-all duration-200 relative overflow-hidden group text-sm sm:text-base ${
                                    acceptTerms
                            ...
                            <button
                                ...
                                className={`w-full py-2.5 sm:py-3 lg:py-4 font-semibold rounded-lg sm:rounded-xl shadow-sm transition-all duration-200 flex items-center justify-center space-x-2 sm:space-x-3 text-sm sm:text-base ${
                                    acceptTerms
