...
const SignIn = () => {
    ...
    return (
        <div className="h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-2 sm:p-4 overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row w-full max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-4xl xl:max-w-5xl h-[95vh] max-h-[800px] min-h-[600px] bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden">
                {/* Left Side */}
                ...
                <div className="w-full lg:w-1/2 p-3 sm:p-4 md:p-6 lg:p-8 xl:p-10 flex flex-col justify-center bg-gradient-to-br from-white to-slate-50 overflow-y-auto">
                    <div className="max-w-xs sm:max-w-sm md:max-w-md mx-auto w-full">
                        ...
                        <form onSubmit={handleSignIn} className="space-y-2 sm:space-y-3 lg:space-y-4">
                            ...
                            <button
                                type="submit"
                                className="w-full py-2 sm:py-2.5 lg:py-3 bg-gradient-to-r from-CloudbyzBlue to-blue-600 text-white font-semibold rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 relative overflow-hidden group text-xs sm:text-sm"
                            >
                            ...
                            <button
                                ...
                                className="w-full py-2 sm:py-2.5 lg:py-3 bg-white border-2 border-gray-300 text-gray-700 font-semibold rounded-lg sm:rounded-xl shadow-sm hover:shadow-md hover:bg-gray-50 transition-all duration-200 flex items-center justify-center space-x-2 text-xs sm:text-sm"
                            >
